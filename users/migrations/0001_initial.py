...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img_profile', models.ImageField(blank=True, null=True, upload_to=users.models.user_directory_path, verbose_name='image profile')),
                ...
                ('pending_list', models.ManyToManyField(related_name='my_pending_list', to=settings.AUTH_USER_MODEL)),
